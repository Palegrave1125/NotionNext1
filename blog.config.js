...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '31efe11fdb298076b10fdd9919ccd27a',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Aerofylax', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '测试界面', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://aerofylax.vercel.app', // 网站地址
